...
export const KEY_MAP: Record<string, MatrixKey[]> = {
  ...
  ArrowLeft: [CAPS_SHIFT, { row: 3, bit: 4 }],
  ArrowDown: [CAPS_SHIFT, { row: 4, bit: 4 }],
  ArrowUp: [CAPS_SHIFT, { row: 4, bit: 3 }],
  ArrowRight: [CAPS_SHIFT, { row: 4, bit: 2 }],
  Backspace: [CAPS_SHIFT, { row: 4, bit: 0 }],
};
