/** Parser and serializer for Amstrad CPC / Spectrum +3 .dsk disk images.
 * Supports both standard ("MV - CPC") and extended ("EXTENDED CPC DSK File") formats. */
...
export class DskImage {
  ...
  /** Serializes the in-memory disk back into a valid Extended DSK image format. */
  serialize(): Uint8Array {
    ...
    // Calculate each track's size and build track byte buffers
    ...
    // Write track sizes high bytes in header table starting at 0x34
